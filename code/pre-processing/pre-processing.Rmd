...
```{r https://ncci.canceraustralia.gov.au/prevention/sun-exposure/sunburn-and-sun-protection}
...
write.csv(combined_df, "../../data/clean/protection.csv", row.names = FALSE)
```
...
write.csv(combined_sunburn_df, "../../data/clean/sunburn.csv", row.names = FALSE)
```
